...
hooks = [
  ...
  },
  {
    ...
    'action': ['python2', 'src/tools/clang/scripts/update.py'],
  },
  {
    ...
    'action': ['python2', 'src/tools/clang/scripts/build.py',
  ...
  },
  {
    ...
    'action': ['python2', 'src/tools/code_coverage/update_clang_coverage_tools.py'],
  },
  {
    ...
    'action': ['python2', 'src/tools/clang/scripts/download_lld_mac.py'],
  },
  {
    # Update LASTCHANGE.
    'name': 'lastchange',
    'pattern': '.',
    'action': ['python2', 'src/build/util/lastchange.py',
